...
Our next steps is to read this paper and https://pub.tik.ee.ethz.ch/students/2014-HS/GA-2014-02.pdf attempt to implement the median and gaussian blur used for image preprocessing in hopes it will remove noise and improve model accuracy.
